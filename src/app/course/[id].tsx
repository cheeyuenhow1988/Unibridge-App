...
const SYSTEM_ORDER: QualificationId[] = ['spm', 'stpm', 'uec', 'alevels', 'ib', 'hkdse', 'gsat', 'atar', 'gpa', 'sma', 'thpt', 'matric', 'krgpa', 'jpgpa'];
const SYSTEM_LABEL: Record<QualificationId, string> = {
  ...
  sma: 'SMA (ID)', thpt: 'THPT (VN)', matric: 'Matric (MM)', krgpa: 'GPA (KR)', jpgpa: '評定 (JP)',
};
